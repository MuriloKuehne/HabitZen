    ...
    return (
      <div className="bg-background min-h-screen">
        <div className="container mx-auto px-4 py-4 sm:py-6 md:py-8">
          <div className="mb-4 sm:mb-6 md:mb-8 animate-in fade-in duration-500">
          ...
          <div className="grid gap-4 sm:gap-6 lg:grid-cols-3 mb-6 sm:mb-8">
            <div className="lg:col-span-2 animate-in fade-in duration-500 delay-200">
              <div className="mb-4 sm:mb-6">
                <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mb-3 sm:mb-4">Your Habits</h2>
                {habits && habits.length > 0 ? (
                  ...
                  <div className="rounded-lg border border-dashed p-6 sm:p-8 md:p-12 text-center">
                    <p className="text-sm sm:text-base text-muted-foreground mb-4">
                      You don&#39;t have any habits created yet.
                    </p>
                    <Link href="/dashboard/habits/new">
                      <Button className="transition-all duration-200 hover:scale-105 min-h-[44px]">
